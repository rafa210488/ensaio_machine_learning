...
![Capa Ensaio de Machine Learning]( images/img1.png)
...
![classificacao_treinamento](images/train_classification.png)
### Sobre os dados de validação
![classificacao_validacao](images/val_classification.png)
### Sobre os dados de teste
![classificacao_teste]( images/test_classification.png)
## Ensaio de regressão:
### Sobre os dados de treinamento
![regressao_treinamento]( images/train_regression.png)
### Sobre os dados de validação
![regressao_validacao]( images/val_regression.png)
### Sobre os dados de teste
![regressao_teste]( images/test_regression.png)
## Ensaio de clusterização:
![clusterizacao_treinamento]( images/clustering.png)
# Conclusão
